...
if __name__ == '__main__':
    ...
    aligned_fn   = 'amrlib/data/working_faa_aligner/amr_alignment_strings.txt'
    ...
    gold_dev_aligns   = gold_dev_aligns[:len(model_dev_aligns)]
    has_test          = len(model_alignments) > 100
    if has_test:
        model_test_aligns = model_alignments[100:200]
        gold_test_aligns = gold_test_aligns[:len(model_test_aligns)]
