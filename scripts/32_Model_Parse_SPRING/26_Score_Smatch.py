...
#GOLD='amrlib/data/tdata_spring/test.txt.nowiki'
#PRED='amrlib/data/model_parse_spring/test-pred.txt'
# Score with the original version meaning the generated files need to have been "wikified"
GOLD='amrlib/data/model_parse_spring/test-gold.txt.wiki'
PRED='amrlib/data/model_parse_spring/test-pred.txt.wiki'
